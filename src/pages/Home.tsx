...
export default function Home() {
  return (
    <>
      <Seo
        title="Terapija.me - Hipnoterapija, Bioenergija, Psihoterapija"
        description="Profesionalni tretmani hipnoterapije, regresoterapije i bioenergije u Crnoj Gori. Kursevi, edukacije i individualni tretmani."
        keywords="hipnoterapija, bioenergija, psihoterapija, terapija, regresoterapija, kursevi, edukacija"
      />
